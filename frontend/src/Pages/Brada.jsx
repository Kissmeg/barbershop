    ...
    <div className=''>
      <div className='pt-40'>
        <div className='flex justify-center'>
          ...
          <h2 className='text-5xl px-4 -translate-y-4'>Brada</h2>
          </div>
        </div>
        <div className='lg:flex justify-center'>
          ...
          <p className="p-8 text-justify border-2 border-[#bc9935] rounded-lg shadow-lg">
              Oblikovanje brade je više od običnog skraćivanja – to je prilika da naglasimo jedinstveni stil i karakter svakog klijenta. Preciznim oblikovanjem linija i prilagođavanjem dužine, brada postaje istaknuti detalj koji upotpunjuje celokupni izgled.
          </p>
