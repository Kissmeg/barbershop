    ...
    <div className=''>
      <div className='pt-40'>
        <div className='flex justify-center'>
          ...
          <h2 className='text-5xl px-4 -translate-y-4'>Štucovanje</h2>
          </div>
        </div>
        <div className='lg:flex justify-center'>
          ...
          <p className="p-8 text-justify border-2 border-[#bc9935] rounded-lg shadow-lg">
              Štucovanje je završni korak doterivanja brade, brkova ili zulufa koji daje preciznost i stil svakom muškom izgledu. Uz pažljivo oblikovanje i vrhunske alate, naš cilj je naglasiti karakter i simetriju – svaki detalj je bitan.
          </p>
